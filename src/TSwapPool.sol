...
contract TSwapPool is ERC20 {
    ...
    //@writte -info 3 events should be indexed if there are more than 3 parameters
    event Swap(
    ...
    function deposit(
        ...
        //IMPACT: A user who ecpects a deposit to fail, will go through. Severe disruption of functionality. 
        ...
        returns (uint256 liquidityTokensToMint)
    {
        ...
        if (totalLiquidityTokenSupply() > 0) {
            ...
            //@audit -gas do not need this line
            ...
            //e if we calculate too many pooltokens to deposit, we revert
            // deposit 10 weth
            // getPoolTokenToDepositBasedOnWeth -> $1,000,000M
    ...
    function _addLiquidityMintAndTransfer(
        ...
        //@written -low this is backwards! Should be 
        //IMPACT: SUPER LOW - protocol is giving the wrong return/information
        // LIKELIHOOD: HIGH
        //(msg.sender,wethToDeposit,poolTokenToDeposit);
        ...
        returns (uint256 inputAmount)
    {
        ...
        //@written -high 
        //IMPACT: HIGH -> users are charged wy too much
    ...
    //@written -info this should be external
        ...
        returns (
            //@written -low
            //IMPACT: SUPER Low - protocolis givimg the wromng return
            //Likelihood: MEDIUM - always the case.
            uint256 output)
    {
        ...
        returns (uint256 inputAmount)
    {
        ...
        // No slippageb protection!!
        //@audit need a max input amount.
        //MEV attacck possible.
    ...
    //@audit this should be external not public
